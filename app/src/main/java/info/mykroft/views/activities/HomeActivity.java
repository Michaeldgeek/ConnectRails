...
public class HomeActivity extends AppCompatActivity
    ...
    int[] sampleImages = {R.drawable.image_, R.drawable.image_2, R.drawable.image_3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupDrawer(toolbar);
        carouselView = (CarouselView)  navigationView.getHeaderView(0);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_cargo) {
            startActivity(new Intent(this,LoginActivity.class));
        }
        else if (id == R.id.log_train) {
            startActivity(new Intent(this,LogTrainActivity.class));
        }
